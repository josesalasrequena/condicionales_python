...
if texto_1[0] > texto_2[0]:
    print('{} su primera letra es mayor que la primera letra de {}'.format(texto_1, texto_2))
else:
    print('{} su primera letra es mayor que la primera letra de {}'.format(texto_2, texto_1))
