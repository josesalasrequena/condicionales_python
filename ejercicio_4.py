...
variable_numerica1 = int(texto_1)
variable_numerica2 = int(texto_2)

if variable_numerica1 > variable_numerica2:
    print('{} es mayor que {}'.format(variable_numerica1, variable_numerica2))
else:
    print('{} es mayor que {}'.format(variable_numerica2, variable_numerica1))
